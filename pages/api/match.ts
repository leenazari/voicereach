...
export function buildScriptFromMatch(candidate: Candidate, matchData: any, job: any): string {
  ...
  const urgencyLine = matchData?.urgency_line || `this one is moving fast and they are ready to hire the right person`

  const script = `Hi ${firstName}... I hope you are having a great day! I have literally just had your CV land on my desk and I had to call you straight away. We have got an absolutely brilliant ${jobTitle} role ${company}${salaryLine} and honestly ${firstName}, ${hookLine}. ${employerLine} makes you such a strong fit for what they need ${sector} and I genuinely think you would love it. I have set up a personal interview link just for you — you can jump in right now, it takes less than ten minutes and you can do it whenever suits you. But please do not wait too long ${firstName}, ${urgencyLine}. Just click the link in this email, do the interview, and let us get you this incredible opportunity. I cannot wait to see you smash it!`
