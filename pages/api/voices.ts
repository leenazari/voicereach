...
const INTERVIEW_LINK_VARIANTS = [
  `I have sent you a direct link to your interview in this email. Click it and you will do a quick nine minute interview — your answers go straight to the hiring manager. No phone screen, no waiting, just click and you are straight in the process.`,
  `The link in this email takes you directly into your interview. It is a nine minute interview, no human on the other end, and your answers go straight to the client. Just click, answer a few questions, and you are in.`,
  `What I have sent you is your actual interview link — not a pre-screen, not a call with me. It is a nine minute interview and everything you say goes directly to the decision maker. Click the link and go.`,
  `I have sent you a link to do your interview right now. Nine minutes, your answers go straight to the hiring team. No middleman, no waiting around — just click and you are in the process.`
]
