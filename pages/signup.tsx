  ...
  if (success) {
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', padding: 24 }}>
        <div style={{ background: 'white', borderRadius: 16, padding: '40px 32px', maxWidth: 420, width: '100%', textAlign: 'center', boxShadow: '0 24px 64px rgba(0,0,0,0.3)' }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>📧</div>
          <div style={{ fontSize: 20, fontWeight: 700, color: '#1a1a1a', marginBottom: 10 }}>Check your email</div>
          <p style={{ fontSize: 14, color: '#888', lineHeight: 1.7, marginBottom: 24 }}>
            We have sent a confirmation link to <strong>{email}</strong>. Click the link to activate your account and get started.
          </p>
          <a href="/login" style={{ display: 'inline-block', padding: '11px 28px', background: '#534AB7', color: 'white', borderRadius: 8, textDecoration: 'none', fontWeight: 600, fontSize: 14 }}>
            Back to sign in
          </a>
        </div>
      </div>
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0f0c29 0%, #302b63 50%, #24243e 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 15, color: 'rgba(255,255,255,0.6)' }}>Create your free account</div>
          <div style={{ marginTop: 8, display: 'inline-block', background: 'rgba(102,126,234,0.2)', border: '1px solid rgba(102,126,234,0.4)', borderRadius: 20, padding: '4px 14px', fontSize: 12, color: '#a78bfa' }}>
            Free plan — 3 voice notes included
          </div>
        </div>
        ...
        <div style={{ background: 'white', borderRadius: 16, padding: '36px 32px', boxShadow: '0 24px 64px rgba(0,0,0,0.3)' }}>
          ...
          <form onSubmit={handleSignup}>
            <div style={{ marginBottom: 14 }}>
              ...
              <input type="text" value={fullName} onChange={e => setFullName(e.target.value)} placeholder="Sarah Johnson" required style={inputStyle} autoFocus />
            </div>
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 12, fontWeight: 600, color: '#666', display: 'block', marginBottom: 6 }}>Work email</label>
            ...
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 12, fontWeight: 600, color: '#666', display: 'block', marginBottom: 6 }}>Password <span style={{ color: '#bbb', fontWeight: 400 }}>(min 8 characters)</span></label>
          ...
          <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: '#888' }}>
            ...
            <a href="/login" style={{ color: '#534AB7', fontWeight: 600, textDecoration: 'none' }}>Sign in</a>
          </div>
        </div>
