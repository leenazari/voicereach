...
export default function Home() {
  ...
  return (
    <>
      ...
      <style jsx global>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
          ...
          .audio-row { flex-direction: column !important; }
          .stats-bar { flex-direction: column !important; }
          .stats-bar > div { border-right: none !important; border-bottom: 1px solid rgba(255,255,255,0.08) !important; padding: 18px 0 !important; }
          ...
          .natalie-label-overlay { display: none !important; }
          .natalie-label-below { display: flex !important; }
        ...
        <div className="audio-row" style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>Sales Manager · EPOS and Payments</div>
            </div>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>Change of role · Career transition</div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 2, height: 24, flexShrink: 0 }}>
      ...
      {/* EXAMPLE SCRIPT */}
      <section style={{ background: 'rgba(83,74,183,0.07)', borderTop: '1px solid rgba(83,74,183,0.15)', borderBottom: '1px solid rgba(83,74,183,0.15)' }}>
        <div className="example-section-inner" style={{ padding: '80px 48px' }}>
            ...
            <div className="reveal">
              ...
              <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: 28 }}>
                ...
                <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ width: 36, height: 36, background: 'var(--purple)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      ...
      <section>
        <div className="section-inner" style={{ padding: '100px 48px', maxWidth: 1200, margin: '0 auto' }}>
          <div className="reveal">
            ...
            <h2 style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(28px, 4vw, 46px)', fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1.1, maxWidth: 620 }}>Numbers that matter to recruiters</h2>
          </div>
      ...
      <section style={{ background: 'rgba(255,255,255,0.02)', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="section-inner" style={{ padding: '80px 48px', maxWidth: 1100, margin: '0 auto', textAlign: 'center' }}>
          <div className="reveal">
            ...
            <h2 style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(24px, 3.5vw, 40px)', fontWeight: 800, letterSpacing: '-0.5px' }}>Recruiters who switched to voice outreach</h2>
          </div>
      ...
      {/* PRICING */}
      <section id="pricing">
        <div className="section-inner" style={{ padding: '100px 48px', maxWidth: 1300, margin: '0 auto' }}>
          <div className="reveal" style={{ textAlign: 'center' }}>
            ...
            <h2 style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(28px, 4vw, 46px)', fontWeight: 800, letterSpacing: '-0.5px', lineHeight: 1.1 }}>Start free. Scale when you are ready.</h2>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginTop: 24, flexWrap: 'wrap' }}>
              ...
              <button onClick={() => setBilling(b => b === 'annual' ? 'monthly' : 'annual')} style={{ width: 48, height: 26, background: 'var(--purple)', borderRadius: 100, cursor: 'pointer', border: 'none', position: 'relative', flexShrink: 0 }}>
