          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
            {STATUSES.map(status => (
              <div
                ...
                style={{
                  background: dragOver === status ? '#f0eeff' : 'white',
                  border: dragOver === status ? '2px dashed #534AB7' : '1px solid #eee',
                  borderRadius: 12,
                  overflow: 'hidden',
              ...
              >
                ...
                <div style={{ padding: 10, display: 'flex', flexDirection: 'column', gap: 8, minHeight: 120 }}>
                  ...
                  {!loading && byStatus(status).length === 0 && (
                    <div style={{ fontSize: 12, color: '#ddd', padding: 8, textAlign: 'center' }}>
                      {dragOver === status ? 'Drop here' : 'Empty'}
                    </div>
                  )}
                </div>
              </div>
